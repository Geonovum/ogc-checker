...
| `/req/core/process-execute-omitted-outputs`                     |    ?     |   No   |         |
| `/req/core/process-execute-empty-outputs`                       |    ?     |   No   |         |
| `/req/core/process-execute-sync-one`                            |    ?     |   No   |         |
| `/req/core/process-execute-success-sync-one-default-content`    |    ?     |   No   |         |
| `/req/core/process-execute-sync-many-json`                      |    ?     |   No   |         |
| `/req/core/process-execute-success-sync-outputs-omitted`        |    ?     |   No   |         |
| `/req/core/process-execute-success-sync-outputs-empty`          |    ?     |   No   |         |
| `/req/core/job-results-success-sync`                            |    No    |   No   |         |
| `/req/core/process-execute-success-async`                       |   Yes    |   No   |         |
| `/req/core/process-execute-success-async-outputs`               |    ?     |   No   |         |
| `/req/core/process-execute-success-async-outputs-empty`         |    ?     |   No   |         |
| `/req/core/process-execute-success-async-outputs-omitted`       |    ?     |   No   |         |
| `/req/core/job-op`                                              |   Yes    |   No   |         |
| `/req/core/job-success`                                         |   Yes    |   No   |         |
| `/req/core/job-exception-no-such-job`                           |   Yes    |   No   |         |
| `/req/core/job-results-op`                                      |   Yes    |   No   |         |
| `/req/core/job-results-param-outputs`                           |   Yes    |   No   |         |
| `/req/core/job-results-param-outputs-response`                  |    No    |   No   |         |
| `/req/core/job-result-op`                                       |   Yes    |   No   |         |
...
| `/req/core/job-results-exception/results-not-available`         |   Yes    |   No   |         |
...
| `/req/ogc-process-description/data-classes`                     |    ?     |   No   |         |
| `/req/ogc-process-description/data-access-apis`                 |    ?     |   No   |         |
| `/req/ogc-process-description/input-def`                        |    ?     |   No   |         |
| `/req/ogc-process-description/input-multiple-types`             |    ?     |   No   |         |
| `/req/ogc-process-description/value-passing`                    |    ?     |   No   |         |
| `/req/ogc-process-description/execution-unit-requirements`      |    ?     |   No   |         |
| `/req/ogc-process-description/outputs-def`                      |    ?     |   No   |         |
| `/req/ogc-process-description/output-def`                       |    ?     |   No   |         |
| `/req/ogc-process-description/output-multiple-types`            |    ?     |   No   |         |
